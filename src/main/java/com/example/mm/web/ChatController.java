...
public class ChatController {
    ...
    @RequestMapping(value = "/removeUserFromChat/{chatId}", method = RequestMethod.POST)
    public void removeUserFromChat(@PathVariable Long chatId, @RequestParam Long userId) {
        logger.info("Trying to remove user with id: {} from chat with id: {}", userId, chatId);
